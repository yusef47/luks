...
⚠️ مهم جداً:
- اضغط على رابط موقع فندق أو booking (مثل booking.com, trivago, marriott)
- استخدم selector: "h3" للعناوين الرئيسية للنتائج
- أو استخدم selector: "a[href*='booking']" أو "a[href*='hotel']"
- لا تضغط على 'المزيد' أو 'الأدوات' أو أي زر في Google
- الهدف: الدخول لموقع فنادق فعلي لاستخراج المعلومات` : ''}

${isProductPage ? `💰 صفحة فندق/منتج:
- استخرج: الأسعار، التقييمات، أسماء الفنادق
- إذا وجدت 3 خيارات أو أكثر، أنهِ المهمة بتقرير
- قارن بين الخيارات وقدم توصية` : ''}

1. الهدف: جمع معلومات حقيقية (أسعار، أسماء، تقييمات)
2. إذا جمعت معلومات عن 3 فنادق، أنهِ المهمة بـ taskComplete: true
3. استخدم selectors محددة، تجنب الأزرار العامة
═════════════════════════════════════
